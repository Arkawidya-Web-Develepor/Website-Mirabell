  ...
  <section class="trust-bar-section">
    <div class="container">
      ...
      <div class="partner-grid">
        <div class="partner-card"><strong>PERTAMINA</strong><span>Group Rekanan</span></div>
        <div class="partner-card"><strong>MEDCO ENERGI</strong><span>Occupational Health</span></div>
        <div class="partner-card"><strong>PETROSEA</strong><span>Fit-to-Work Partner</span></div>
        <div class="partner-card"><strong>KPC & THIESS</strong><span>Mining Support</span></div>
        <div class="partner-card"><strong>SCHLUMBERGER</strong><span>Energy Services</span></div>
        <div class="partner-card"><strong>AdMedika</strong><span>TPA Provider</span></div>
        <div class="partner-card"><strong>MANDIRI INHEALTH</strong><span>Insurance Partner</span></div>
        <div class="partner-card"><strong>BPJS KESEHATAN</strong><span>Faskes Mitra</span></div>
      </div>
    </div>
  </section>
