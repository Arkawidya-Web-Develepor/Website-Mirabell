...
<head>
  <link rel="icon" type="image/png" href="assets/images/brand/mirabel-transparent.png">
    ...
    <div class="container footer-grid">
      <div class="footer-col about-col">
        <div class="brand-logo footer-logo">
          <div class="logo-symbol">
            <img src="assets/images/brand/mirabel-transparent.png" alt="Logo Klinik Utama Mirabell" width="40" height="40" style="object-fit: contain; display: block;">
          </div>
          <div class="logo-text">
            <span class="brand-name" style="color: #FFFFFF;">MIRA<span style="color: #F87171;">BELL</span></span>
            <span class="brand-category" style="color: #FCA5A5;">KLINIK UTAMA &amp; LAYANAN MEDIS TERPADU</span>
          </div>
        </div>
        <p class="footer-desc">
